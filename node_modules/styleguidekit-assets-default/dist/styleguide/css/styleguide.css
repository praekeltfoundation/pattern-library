...
.sg-nav > li > ol:nth-child(1) li a a {
  padding: 10px;
}
.sg-nav > li > ol:nth-child(1) li a:nth-child(1) a {
  padding: 10px;
}
.sg-nav > li a {
  display: block;
...
.sg-acc-panel > li:nth-child(1) a {
  padding: 10px;
}
.sg-acc-panel .sg-sub-nav > li:nth-child(1) a {
  padding: 10px;
}
