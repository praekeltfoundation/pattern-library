...
.sg-header #pl-pattern-nav-target li:first-child a {
  padding: 1em 0.7em 1em 0;
}
.sg-header #pl-pattern-nav-target .sg-acc-panel li a {
  padding: 1em 0.7em;
}

.pattern-library__logo {
  padding: 10px 0 0;
}
.pattern-library__logo h1 {
  font-size: 15px;
  font-weight: bold;
  margin: 0;
  color: #fff;
...
.pattern-library__logo h1 a {
  color: #fff;
  font-size: 100%;
  padding: 0;
}
.pattern-library__logo h1 a:hover, .pattern-library__logo h1 a:focus, .pattern-library__logo h1 a.active {
  color: #ccc;
  background: none;
}
.pattern-library__logo h1 small {
  font-size: 12px;
  color: #A6ACAF;
  font-weight: normal;
  padding-left: 16px;
