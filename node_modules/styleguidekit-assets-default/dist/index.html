...
<html>
  <head>
    <title id="title">Pattern Library</title>
    <meta charset="UTF-8">
  ...
  <body>
    ...
    <header class="sg-header" role="banner">
      <a href="/" class="heading-logo">Molo Design System <small>Beta</small></a>
    ...
    <div id="sg-vp-wrap">
      ...
      <div id="sg-gen-container">
        <iframe id="sg-viewport" name="sg-viewport" sandbox="allow-same-origin allow-scripts allow-popups allow-forms">
        </iframe>
        <div id="sg-rightpull-container">
          <div id="sg-rightpull" class="right-pull"></div>
        </div>
      </div>
    </div>
    <!--end iFrame-->
    ...
    <div id="sg-modal-container" class="sg-modal anim-ready" style="bottom: -2000px">
      ...
      <!--end .sg-modal-close-btn-->

      <div id="sg-modal-content" class="sg-modal-content"></div>
      <!--end .sg-modal-content-->
    ...
    <script type="text/mustache" id="pl-pattern-nav-template">
      {{# patternTypes }}
  <li>
    <a class="sg-acc-handle">{{ patternTypeUC }}</a>
  ...
  <ul class="sg-control">
    <li class="sg-size">
      ...
      <ul class="sg-size-options">
        {{^ ishControlsHide.s }}
          <li><a href="#" id="sg-size-s">Small</a></li>
        {{/ ishControlsHide.s }}
        {{^ ishControlsHide.m }}
          <li><a href="#" id="sg-size-m">Medium</a></li>
        {{/ ishControlsHide.m }}
        {{^ ishControlsHide.l }}
          <li><a href="#" id="sg-size-l">Large</a></li>
        {{/ ishControlsHide.l }}
        {{^ ishControlsHide.full }}
          <li><a href="#" id="sg-size-full">Full Browser</a></li>
        {{/ ishControlsHide.full }}
        ...
        {{/ ishControlsHide.disco }}
        {{^ ishControlsHide.hay }}
          <li><a href="#" class="mode-link" id="sg-size-hay">Auto</a></li>
        {{/ ishControlsHide.hay }}
      </ul>
    </li>
